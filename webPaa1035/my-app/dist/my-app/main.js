...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'login',
            template: __webpack_require__(/*! ./login.component.html */ "./src/app/admin/login.component.html"),
            styles: [__webpack_require__(/*! ./login.component.scss */ "./src/app/admin/login.component.scss")]
        }),
        __metadata("design:paramtypes", [_model_rest_datasource__WEBPACK_IMPORTED_MODULE_1__["RestSourceData"]])
    ], LoginComponent);
...
/***/ "./src/app/admin/registration.component.html":
/*!***************************************************!*\
  !*** ./src/app/admin/registration.component.html ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/app/admin/registration.component.scss":
/*!***************************************************!*\
  !*** ./src/app/admin/registration.component.scss ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/app/admin/registration.component.ts":
/*!*************************************************!*\
  !*** ./src/app/admin/registration.component.ts ***!
  \*************************************************/
...
var RegistrationComponent = /** @class */ (function () {
    function RegistrationComponent(data) {
        this.data = data;
        this.registerData = {};
    }
    RegistrationComponent.prototype.Post = function () {
    ...
    ], RegistrationComponent.prototype, "control", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], RegistrationComponent.prototype, "placeholder", void 0);
    RegistrationComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'registration',
            template: __webpack_require__(/*! ./registration.component.html */ "./src/app/admin/registration.component.html"),
            styles: [__webpack_require__(/*! ./registration.component.scss */ "./src/app/admin/registration.component.scss")]
        }),
        __metadata("design:paramtypes", [_model_rest_datasource__WEBPACK_IMPORTED_MODULE_2__["RestSourceData"]])
...
/* harmony import */ var _master_master_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./master/master.component */ "./src/app/master/master.component.ts");
...
/* harmony import */ var _admin_registration_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./admin/registration.component */ "./src/app/admin/registration.component.ts");
/* harmony import */ var _admin_login_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./admin/login.component */ "./src/app/admin/login.component.ts");
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"].forRoot([
                    ...
                    { path: "view/:id", component: _master_view_component__WEBPACK_IMPORTED_MODULE_15__["ViewComponent"] },
...
/***/ "./src/app/master/dialog-overview-example-dialog.html":
/*!************************************************************!*\
  !*** ./src/app/master/dialog-overview-example-dialog.html ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./src/app/master/dialog-overview-example-dialog.ts":
/*!**********************************************************!*\
  !*** ./src/app/master/dialog-overview-example-dialog.ts ***!
  \**********************************************************/
...
var DialogOverviewExampleDialog = /** @class */ (function () {
    function DialogOverviewExampleDialog(dialogRef, data, dataRef) {
    ...
    DialogOverviewExampleDialog = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'modal',
            template: __webpack_require__(/*! ./dialog-overview-example-dialog.html */ "./src/app/master/dialog-overview-example-dialog.html"),
        }),
        __param(1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"])),
        __metadata("design:paramtypes", [_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatDialogRef"], Object, src_app_model_rest_datasource__WEBPACK_IMPORTED_MODULE_2__["RestSourceData"]])
...
var MasterComponent = /** @class */ (function () {
    ...
    MasterComponent.prototype.openDialog = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_dialog_overview_example_dialog__WEBPACK_IMPORTED_MODULE_2__["DialogOverviewExampleDialog"], {
            width: '250px',
...
/***/ "./src/app/master/view.component.html":
/*!********************************************!*\
  !*** ./src/app/master/view.component.html ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./src/app/master/view.component.scss":
/*!********************************************!*\
  !*** ./src/app/master/view.component.scss ***!
  \********************************************/
/*! no static exports found */
...
/***/ "./src/app/master/view.component.ts":
/*!******************************************!*\
  !*** ./src/app/master/view.component.ts ***!
  \******************************************/
...
var ViewComponent = /** @class */ (function () {
    function ViewComponent(route, data) {
        this.route = route;
        this.data = data;
        this.position = 'my-app';
        this.data.getMessage();
    }
    ...
    ViewComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'view',
            template: __webpack_require__(/*! ./view.component.html */ "./src/app/master/view.component.html"),
            styles: [__webpack_require__(/*! ./view.component.scss */ "./src/app/master/view.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], src_app_model_rest_datasource__WEBPACK_IMPORTED_MODULE_2__["RestSourceData"]])
    ], ViewComponent);
...
/*!******************************************!*\
  !*** ./src/app/model/rest.datasource.ts ***!
  \******************************************/
/*! exports provided: RestSourceData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RestSourceData", function() { return RestSourceData; });
...
var RestSourceData = /** @class */ (function () {
    function RestSourceData(http, route) {
        this.http = http;
        this.route = route;
        this.messages = [];
        this.dashboard = [];
    ...
    RestSourceData.prototype.postMessage = function (message) {
        var _this = this;
        this.messages.push(message);
        this.http.post(this.authPath + '/post', message).subscribe(function (res) {
            _this.messages = res;
        });
        setTimeout(function () {
            _this.getDashboard();
            _this.route.navigateByUrl('/detail');
        }, 1000);
        setTimeout(function () {
            _this.route.navigateByUrl('/master');
        }, 1000);
    };
    Object.defineProperty(RestSourceData.prototype, "token", {
        get: function () {
    ...
    Object.defineProperty(RestSourceData.prototype, "isAuthenticated", {
        get: function () {
            return !!localStorage.getItem(this.TOKEN_KEY);
        },
        enumerable: true,
...
module.exports = __webpack_require__(/*! C:\Users\Rey Messon\Desktop\doceavoejercicio\webPaa1035\my-app\src\main.ts */"./src/main.ts");
